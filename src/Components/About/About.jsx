...
<div className="about-right">
    ...
    <p>Embark on a transformative educational journey with our 
        university's comprehensive education programs. Our cutting-edge curriculum is
        ...
        <p> With a focus on innovation, hands-on learning, and personalized mentorship,
             our programs prepare aspiring educators 
            ...
            <p>Whether you aspire to become a teacher, administrator, counselor, or educational leader,
                ...
                and unlock your full potential in shaping the future of education.</p></div>      
    </div>
  )
}
